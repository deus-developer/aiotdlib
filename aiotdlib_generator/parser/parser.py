...
def _default_value_based_on_type(
    arg_type: str, arg_default_value: typing.Optional[str] = None
    ...
    def parse() -> list[typing.Union[Constructor, Function]]:
        ...
        for line in [line.strip() for line in scheme.splitlines()[14:] if len(line) > 0]:
            ...
            if bool(entity_match):
                ...
                for arg_name, arg_type in entity_args:
                    ...
                    for c in arg_constraints:
                        ...
                        if bool(default_value_match):
                            ...
                            arg_default_value, arg_default_factory = _default_value_based_on_type(
                        ...
                        if bool(empty_default_value_match):
                            arg_default_value, arg_default_factory = _default_value_based_on_type(arg_type)
                    ...
                    p = Parameter(
                        ...
                        default_factory=arg_default_factory,
                ...
                entity_parameters = sorted(
                    entity_parameters, key=lambda x: x.default_value is not None or x.default_factory is not None
                )
